...
// Separated so useSearchParams() is inside a Suspense boundary (Next.js 14 requirement)
function LoginForm() {
    ...
    return (
        <div className="w-full max-w-sm">
            ...
            <p className="text-muted text-sm mb-8">
                {mode === "login" ? "Sign in to your PolyLens account" : "Start your free PolyLens account"}
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        className="w-full bg-white/5 border border-border rounded-xl px-4 py-3 text-white placeholder-muted text-sm outline-none focus:border-primary/60 transition-colors"
                    />
                </div>
                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full bg-white/5 border border-border rounded-xl px-4 py-3 pr-11 text-white placeholder-muted text-sm outline-none focus:border-primary/60 transition-colors"
                        />
                ...
                {success && <div className="text-sm text-positive bg-positive/10 border border-positive/20 rounded-lg px-4 py-3">{success}</div>}
...
export default function LoginPage() {
    return (
        <div className="min-h-screen bg-[#050810] flex">
            ...
            {/* Right — auth form wrapped in Suspense (required for useSearchParams) */}
            <div className="flex-1 flex items-center justify-center p-6">
                <Suspense fallback={<div className="w-full max-w-sm space-y-4 animate-pulse">
